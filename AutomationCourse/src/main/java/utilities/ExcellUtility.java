...
public class ExcellUtility {
	...
	{
		f= new FileInputStream("C:\\Users\\Zartech\\git\\Selenium\\AutomationCourse\\src\\test\\resources\\TestData.xlsx");
	...
	public static String getIntegerData(int a, int b,String sheet ) throws IOException
	{
		...
		return String.valueOf(j);//convert int value to string value(type convertion)
	}
